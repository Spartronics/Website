# Spartronics5048.com Gihub Repository

This is the full contents of spartronics5048.com (or will be, once we upload this and replace the old one.) Team members feel free to edit this site; it will hopefully be automatically synced with the web server once I figure out how to set that up. Outsiders can add suggestions and submit patches, but keep in mind that there's a good chance we'll reject it if it isn't up to our snuff.
...
###Videos
* DO NOT COMMIT VIDEOS TO THIS RWPOSITORY. Upload them to Youtube and either embed it or place it's link in the gallery JSON.
